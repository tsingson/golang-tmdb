...
func (s *Client) GetGuestSessionRatedMovies(
	id string,
	...
	if err := s.get(tmdbURL, &guestSessionRatedMovies); err != nil {
		return nil, err
	}
...
func (s *Client) GetGuestSessionRatedTVShows(
	id string,
	urlOptions map[string]string,
	...
	if err := s.get(tmdbURL, &guestSessionRatedTVShows); err != nil {
		return nil, err
	}
...
func (s *Client) GetGuestSessionRatedTVEpisodes(
	id string,
	urlOptions map[string]string,
	...
	if err := s.get(tmdbURL, &guestSessionRatedTVEpisodes); err != nil {
		return nil, err
	}
